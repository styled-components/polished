...
let timingFunction: polished.TimingFunction;
...
let pointingDirection: polished.Direction;
...
const parseToHsl: polished.HslColor | polished.HslaColor = polished.parseToHsl("rgb(255, 0, 0)");
const parseToRgb: polished.RgbColor | polished.RgbaColor = polished.parseToRgb("rgb(255, 0, 0)");
...
let elementState: polished.ElementState;
elementState = "active";
elementState = "focus";
elementState = "hover";

let positionType: polished.Position;
