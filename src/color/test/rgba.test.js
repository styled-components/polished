...
describe('rgb', () => {
  ...
  it('should convert a rgba object to a rgba string', () => {
    expect({
      background: rgba({ red: 255, green: 205, blue: 100, alpha: 0.75 }),
    }).toMatchSnapshot()
  })

  it('should convert a rgba object with full opacity to a hex color', () => {
    expect({
      background: rgba({ red: 255, green: 205, blue: 100, alpha: 1 }),
    }).toMatchSnapshot()
  })

  it('should convert a rgba object with full opacity to a reduced hex color', () => {
    expect({
      background: rgba({ red: 255, green: 255, blue: 255, alpha: 1 }),
    }).toMatchSnapshot()
  })
  ...
  it('should throw an error if an object and multiple arguments are passed', () => {
    expect(() => ({
      background: rgba(
        { red: 255, green: 1, blue: 1, alpha: 180 },
        250,
        100,
        0.5
      ),
