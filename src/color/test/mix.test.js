...
describe('mix', () => {
  ...
  it('should mix a color with a color with an opacity lower than 1', () => {
    expect(mix(0.51, 'rgba(242, 236, 228, 0.5)', '#6b717f')).toEqual(
      'rgba(141,144,153,0.745)',
    )
  })

  it('should mix two rgba colors', () => {
    expect(mix(0.7, 'rgba(0, 0, 0, 1)', 'rgba(255, 255, 255, 0)')).toEqual(
      'rgba(0,0,0,0.7)',
    )
  })
  ...
  it('should return color when passed transparent otherColor', () => {
    expect(mix('0.5', 'rgba(255, 0, 0, 0.5)', 'transparent')).toEqual(
      'rgba(255, 0, 0, 0.5)',
    )
  })
  ...
  it('should return the second color when weight is 0', () => {
    expect(mix(0, 'rgba(0, 0, 0, 1)', 'rgba(255, 255, 255, 0)')).toEqual(
      'rgba(255, 255, 255, 0)',
    )
  })
})
