...
//      
function formatMessage(type, messageBody) {
  var moduleName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'moduleName';
  var modulePath = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'modulePath';
...
function messageHandler(type, messageBody, modulePath) {
  var moduleName = modulePath.match(/([^/]+)(?=\.\w+$)/)[0];
  ...
  if (type === 'error') {
    ...
    (_console = console).error.apply(_console, [message, headerStyles].concat(messageStyles));
  } else {
    var _console2;

    // eslint-disable-next-line no-console
    (_console2 = console).warn.apply(_console2, [message, headerStyles].concat(messageStyles));
  }
}
...
function clearFix() {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/clearFix.js';
    deprecatedCheck(modulePath);
...
function ellipsis() {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/ellipsis.js';
    deprecatedCheck(modulePath);
  }
...
function fontFace(_ref) {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/fontFace.js';
    deprecatedCheck(modulePath);
  }
...
function hideText() {
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/hideText.js';
    deprecatedCheck(modulePath);
  }
...
function hiDPI() {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/hiDPI.js';
    deprecatedCheck(modulePath);
  }
...
function placeholder(styles) {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/placeholder.js';
    deprecatedCheck(modulePath);
  }
...
function radialGradient(_ref) {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/radialGradient.js';
    deprecatedCheck(modulePath);
  }
...
function retinaImage(filename, backgroundSize) {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/retinaImage.js';
    deprecatedCheck(modulePath);
  }
...
function selection(styles) {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/selection.js';
    deprecatedCheck(modulePath);
  }
...
function timingFunctions(timingFunction) {
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/timingFunctions.js';
    deprecatedCheck(modulePath);
  }
...
function triangle(_ref) {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/triangle.js';
    deprecatedCheck(modulePath);
  }
...
function wordWrap() {
  ...
  /* istanbul ignore next */
  if (process.env.NODE_ENV !== 'production') {
    var modulePath = 'mixins/wordWrap.js';
    deprecatedCheck(modulePath);
  }
