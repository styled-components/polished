(function (global, factory) {
  ...
  function warning(messageBody) {
    messageHandler.apply(undefined, ['warning', messageBody].concat(getModuleInfo(getCaller())));
  }
  ...
  function normalize(excludeOpinionated) {
...

    {
      if (excludeOpinionated) {
        warning('The excludeOpinionated option for normalize has been removed in polished 2.0. opinionatedRules were removed from normalize.css in 6.0 and no longer need to be explicitly excluded from normalize.');
      }
    }
    return _ref = {
      html: {
  ...
  function placeholder(styles) {
    ...
    {
      warning('placeholder has been marked for deprecation in polished 2.0 and will be fully deprecated in 3.0. It is no longer needed and can safely be replaced with the non-prefixed placeholder pseudo-element.');
    }
  ...
  function selection(styles) {
    ...
    {
      warning('selection has been marked for deprecation in polished 2.0 and will be fully deprecated in 3.0. It is no longer needed and can safely be replaced with the non-prefixed selection pseudo-element.');
    }
