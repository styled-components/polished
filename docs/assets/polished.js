...
var warningStyles = 'padding: 2px; font-weight: bold; background: yellow; color: black';

function formatMessage(type, modulePath, messageBody, docPath) {
...
function messageHandler(type, modulePath, messageBody, docPath) {
  var message = formatMessage(type, modulePath, messageBody, docPath);
...
function error$1(modulePath, messageBody, docPath) {
...
function normalize(excludeOpinionated) {
  {
    if (typeof excludeOpinionated !== 'boolean') {
      var modulePath = 'mixins/normalize.js';
      var messageBody = 'normalize optionally takes a boolean that determines if opinionated rules should be included. However, you provided a parameter of type ' + (typeof excludeOpinionated === 'undefined' ? 'undefined' : _typeof(excludeOpinionated)) + ' instead.';
      var docPath = '#normalize';
      error$1(modulePath, messageBody, docPath);
    }
  }
...
function mix(colorOrWeight, color, otherColor) {
  ...
  var parsedColor1 = parseToRgb(colorString1);
  var color1 = _extends({}, parsedColor1, {
    alpha: typeof parsedColor1.alpha === 'number' ? parsedColor1.alpha : 1
  });

  var parsedColor2 = parseToRgb(colorString2);
